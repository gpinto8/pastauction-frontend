...
async function takeData() {
    try {
        // Effettua la richiesta HTTP e attendi la risposta
        const response = await httpGet('filter/bidwatcher_brand/name');
        console.log('Dati ricevuti:', response.data);
        return response.data; // Restituisci i dati ricevuti dalla richiesta
    } catch (error) {
...
// Esempio di utilizzo:
const tablename = 'bidwatcher_brand';
const column_name = 'name';
fetchProductListById(tablename, column_name)
    .then((data: any) => {
...
onMounted(async () => {
    // Esegui la funzione takeData e attendi che restituisca i dati
    try{
        const data = await takeData();
        console.log('Dati ricevuti da takeData:', data);
    }catch(err){
        console.log(err);
    }
    // fetchData();
    ...
    <div class="flex flex-col gap-8 mb-96">
        ...
        <div class="flex flex-col gap-3 rounded p-2 my_search_bar">
            <div class="flex items-stretch gap-5">
                ...
                <MySelect table-name="bidwatcher_brand" column-name="name"></MySelect>
                <MySelect table-name="bidwatcher_brand" column-name="name"></MySelect>
                <MySelect table-name="bidwatcher_age" column-name="name"></MySelect>
