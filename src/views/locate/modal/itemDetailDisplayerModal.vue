...
<template>
	<Modal :is-modal-open="modalStates.itemDetailDisplayerModal" @overlay-click="modalStates.itemDetailDisplayerModal = false">
		<div class="flex flex-col gap-2 bg-white p-8 w-full sm:min-w-[24rem] sm:max-w-[50rem] m-4 max-h-full overflow-hidden rounded-lg shadow-lg relative">
