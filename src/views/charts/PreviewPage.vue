      ...
      <v-container fluid>
        <v-row justify="start">
          <v-col class="d-flex flex-column">
            ...
            <span style="font-size: xx-small; color: grey;">Charts below rappresent a preview with a default standard dataset</span>
          </v-col>
        </v-row>
        <v-row justify="start">
          <v-expansion-panels>
                ...
                <v-expansion-panel-text>
                  <v-row >
                      <v-col
                        ...
                        sm="4"
                      >
                      <v-card title="North American sales in th world (map)" text="Explore North American's car auction stats by city: total sales, vehicle counts, top sales, auction events. Interactive bubbles show revenue scale.">
                      ...
                      <v-col
                        ...
                        sm="4"
                      >
                      <v-card title="Pie chart car type offered" text="Analyzing the distribution of car shapes in the dataset.">
                      ...
                      <v-col
                        ...
                        sm="4"
                      >
                      <v-card title="European sales in th world (map)" text="Explore european's car auction stats by city: total sales, vehicle counts, top sales, and auction events. Interactive bubbles show revenue scale.">
              ...
              <v-expansion-panel-text>
                <v-row >
                    ...
                    <v-col
                      ...
                      sm="4"
                    >
                    <v-card title="Plot comparison maison sales by year" text="Comparison of Average and Total Sales by Maison">
                    ...
                    <v-col
                      ...
                      sm="4"
                    >
                    <v-card title="Plot number sales rate vehicles by age" text="An analysis of vehicle sales and sales rate based on age">
                    ...
                    <v-col
                      ...
                      sm="4"
                    >
                    <v-card title="Plot top cities sales europe" text="Explore the sales and average prices of the most popular European cities.">
