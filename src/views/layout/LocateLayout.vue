...
import { useLocateRoadmapStore, type RoadmapData } from '@/store/locate/locateRoadmapStore'
...
const { roadmaps, roadmapsLoading } = storeToRefs(roadmapStore);
...
<template>
	<div>
		...
		<div v-if="itemsLoading || roadmapsLoading" class="absolute w-full h-full top-0 left-0 bg-[#00000070] z-20 flex items-center justify-center">
